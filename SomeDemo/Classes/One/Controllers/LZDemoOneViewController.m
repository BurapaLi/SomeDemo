...
#pragma mark - 创建设备唯一的UID

- (void)createdeviceUUID{
    
//    self.deviceUUID = [[UIDevice currentDevice].identifierForVendor UUIDString];
//    fSLog(@"%@",self.deviceUUID);
//    KeychainItemWrapper *keyChainItem = [[KeychainItemWrapper alloc] initWithIdentifier:@"Identifier" accessGroup:@"自定义去 比如帅比LEE"];
//    
//    id obj = [keyChainItem objectForKey:(id)kSecValueData];
//    
...
//        self.deviceUUID = [[UIDevice currentDevice].identifierForVendor UUIDString];
//        
//        [keyChainItem setObject:self.deviceUUID forKey:(id)kSecValueData];
//        
//    }
//    
//    NSLog(@"deviceUUID : %@", self.deviceUUID);
